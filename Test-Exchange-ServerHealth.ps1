...
$ignorelistfile = "P:\Skript\Exchange, Lync og communications\rapporter\ignorelist.txt"	#Path to the txt file containing list of server names to ignore
...
$smtpsettings = @{
	To =  "hakh@soprasteria.com"
	From = "xhovhan@jbv.no"
	Subject = "Exchange Server Health Report - $now"
	SmtpServer = "smtp.common.jernbaneverket.local"
	}
